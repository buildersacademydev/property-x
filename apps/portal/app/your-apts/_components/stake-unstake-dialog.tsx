...
export type StakeFormValues = z.infer<typeof stakeSchema> & { kind: "stake" }
export type UnstakeFormValues = z.infer<typeof unstakeSchema> & { kind: "unstake" }
export type FormValues = StakeFormValues | UnstakeFormValues
